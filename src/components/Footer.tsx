        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Premium Friseur für den modernen Gentleman. 
              Tradition trifft auf zeitgemäßen Stil seit 2021.
            </p>
            <div className="flex gap-4">
              <a 
                href="https://www.instagram.com/friseurben19/" 
                target="_blank" 
              ...
              <a 
                href="https://www.facebook.com/friseurben19/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:border-primary hover:text-primary transition-all duration-300"
                aria-label="Facebook"
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex justify-between text-muted-foreground">
                <span>Freitag</span>
                <span className="text-foreground">09:00 - 13:00 und 14:00 - 19:00</span>
              </li>
              <li className="flex justify-between text-muted-foreground">
                <span>Sonntag</span>
      ...
      <div className="border-t border-border">
        <div className="container mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground text-sm">
            © {currentYear} Friseur Ben 19. Alle Rechte vorbehalten.
          </p>
